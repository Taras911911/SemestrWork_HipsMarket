...
public class StocktakingServiceImpl implements StocktakingService {
    ...
    @Override
    public List<Stocktaking> getAllByStockId(long id) {
        return stocktakingRepository.findAllByStockId(id);
    }
    ...
    @Override
    public int getAllQuantityOnStock(List<Stocktaking> stocktaking) {
        int quantity = 0;
