...
<div class="collapse navbar-collapse"><a class="btn btn-success" href="/admin/main">Admin</a>
    <a class="btn btn-success" href="/admin/stock/add">Add stock</a></div>
<h1>Free Stocks</h1>
<table class="table table-bordered">
    ...
    <core:forEach var="war" items="${stocks}">
        <tr>
                ...
                <td>${war.street}</td>
                <td>
                    <a href="/admin/stock/${war.id}" class="btn btn-primary">About Stock</a>
                </td>
